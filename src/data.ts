...
export const selfCareQuestions: Question[] = [
  {
    question: '"Everything is awful and I am not OK."',
    intervention: "The following are questions to ask before giving up.",
    override: true,
    buttons: {
      yes: false,
      no: false,
  ...
  {
    question: "Do you feel paralyzed by indecision?",
    intervention:
  ...
  {
    question: "You’ve made it this far, and you will make it through.",
    intervention: "You are stronger than you think.",
    override: true,
    buttons: {
      yes: false,
      no: false,
